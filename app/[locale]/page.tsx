...
import { Zap, ClipboardList, Wifi, ArrowRight } from "lucide-react";
    ...
    <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex size-12 items-center justify-center rounded-lg bg-sky-500/10 text-sky-500 transition-colors group-hover:bg-sky-500/20">
            ...
            <div>
              <h3 className="font-semibold text-lg leading-tight">
                {t("cards.router.title")}
              </h3>
              <p className="mt-1 text-sm text-muted-foreground leading-relaxed">
                {t("cards.router.description")}
              </p>
            </div>
          </Link>
        </div>
